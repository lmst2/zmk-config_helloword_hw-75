...
if (ZMK_CONFIG)
    ...
    if(EXISTS ${ZMK_CONFIG}/zephyr/module.yml)
        message(STATUS "Adding ZMK config directory as extra module: ${ZMK_CONFIG}")
        list(APPEND ZEPHYR_EXTRA_MODULES ${ZMK_CONFIG})
    endif()
endif()
